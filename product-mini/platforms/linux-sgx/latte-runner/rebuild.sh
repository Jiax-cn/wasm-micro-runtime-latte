...
cp /home/jiax/Desktop/wasm_workspace/portmr/tools/latte_builder/latte_runner.wasm ./
cp /home/jiax/Desktop/wasm_workspace/portmr/tools/latte_builder/runner.wasm.id ./
